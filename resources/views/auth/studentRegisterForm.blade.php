        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div class=" ">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('auth.studentRegister') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <h5 for="school_id" class="col-form-label d-flex   text-gr size-16">{{ __('dashboard.schoolName') }}<div class="size-11 px-1 text-danger">*</div></h5>
                                    <select name="school_id" id="school_id" class="form-control shadow-none form-select pe-5" >
                                    </select>
                                    @error('school_id')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
