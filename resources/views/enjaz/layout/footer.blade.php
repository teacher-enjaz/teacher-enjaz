...
<section class="footer container pt-3 mt-2">
    ...
    <div class="row border-top mx-5 py-5 px-5 wow fadeInUp" data-wow-delay=".2ms" data-wow-duration="1000ms" style="visibility: visible; animation-duration: 1000ms; animation-delay: 0ms; animation-name: fadeInUp;">
        ...
        <div class="col-12 col-md-3">
            <a rel="license" style="text-decoration: none;" class="col-12 text-center font-24 mt-2" target="_blank" href="https://creativecommons.org/licenses/by-nc-nd/4.0/deed.ar?fbclid=IwAR2FE8fCEntGuRkthCFx8tDhfXQVpknWNGLaLi7OIxyWMNR36XzBB7hIikg" title="Creative Commons Attribution 4.0 International license">
        ...
        <div class="col-12 col-md-4 link-social">
            <ul class="ps-0 d-flex justify-content-end">
                ...
                <li class="my-2">
                    <a href = "#" class="size-24 p-2"><i class="fa fa-facebook-square"></i> </a>
                </li>
            </ul>
        </div>
    </div>
