<div class="modal fade edit-initiative-eModal" id="edit-initiative-eModal" tabindex="-1" aria-labelledby="edit-initiative-eModal" aria-hidden="true">
    <div class="modal-dialog  modal-xl modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header ">
                <h5 class="modal-title" id="exampleModalLabel">{{__('enjaz.editInitiative')}}</h5>
                <button type="button" class="btn-close ms-0" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editInitiativeForm" name="editInitiativeForm" method="POST" action="">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body p-3 m-5 mt-0" >
                    <div class="row">
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-sm-12 mt-3">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="edit_target_group" name="target_group">
                                    <label for="floatingInput" >{{__('enjaz.target_group')}}</label>
                                    <div class="text-danger" id="editTargetGroupError"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-sm-12 mt-3">
                                <div class="form-floating mb-3">
                                    <textarea class="form-control" id="edit_team" name="team" rows="5"></textarea>
                                    <label for="floatingInput" >{{__('enjaz.teams')}}</label>
                                    <div class="text-danger" id="editTeamError"></div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6 col-sm-12 mt-3">
                                <div class="form-floating mb-3">
