<div class="modal fade add-achievement-eModal" id="add-achievement-eModal" tabindex="-1" aria-labelledby="add-achievement-eModal" aria-hidden="true">
    <div class="modal-dialog  modal-xl modal-dialog-centered ">
        <div class="modal-content">
            <div class="modal-header ">
                <h5 class="modal-title" id="exampleModalLabel">{{__('enjaz.addAchievement')}}</h5>
                <button type="button" class="btn-close ms-0" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="achievementForm" name="achievementForm" method="POST" action="{{route('achievements.store')}}">
                @csrf
