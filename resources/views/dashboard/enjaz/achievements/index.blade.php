...
@section('content')
                    ...
                    <div class="container-fluid ">
                        ...
                        <section class="row section">
                            ...
                            <div class="section-title mb-2 ">
                                <h1 class="h3 mb-0 text-gray-800">{{__('enjaz.achievements')}}</h1>
                                <p class="section-hint">
                                    {{__('enjaz.addAchievements')}}
                                </p>
                            </div>
                            <div class="d-flex justify-content-between align-items-center ">
                                <a href="" class="custom-btn create-btn add-btn mt-4 " data-bs-toggle="modal" data-bs-target="#add-achievement-eModal">
                                    ...
                                    @foreach($contents as $index=>$content)
                                        <div class="col-12 col-md-4 " style="width: 33.33%;height: max-content">
                                            <div class="card articel-card shadow my-4 p-0">
                                                ...
                                                <div class="category">
                                                    <span>{{__('enjaz.achievement')}}</span>
                                                </div>
                                            </div>
    ...
    @include('dashboard.enjaz.achievements.create')
    @include('dashboard.enjaz.achievements.edit')
@endsection
@section('script')
    <script type="text/javascript" src="{{asset('template/js/plugins/jquery.dataTables.min.js')}}"></script>
    <script type="text/javascript" src="{{asset('template/js/generalScript.js')}}"></script>
    <script src="https://cdn.jsdelivr.net/npm/summernote@0.8.18/dist/summernote.min.js"></script>
    <script src="{{asset('enjaz/js/achievement.js')}}"></script>
@endsection
