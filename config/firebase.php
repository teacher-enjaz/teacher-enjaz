...
return [
     ...
     *
     * If you don't provide credentials, the Firebase Evaluator SDK will try to
     * autodiscover them
     *
     ...
     * first time you try to access a component of the Firebase Evaluator SDK.
     *
     */
    'credentials' => [
     ...
     * ------------------------------------------------------------------------
     *
     * The Firebase Evaluator SDK can cache some data returned from the Firebase
